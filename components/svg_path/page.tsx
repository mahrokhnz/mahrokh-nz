...
const SvgPath = () => {
    return (
        <svg className="absolute inset-x-0 bottom-0 z-0 fill-(--secondaryColor) [&_circle]:fill-(--primaryColor)" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
            <path className="fill-(--secondWaveColor)"
                  ...
                  fill="currentColor"
                  fillOpacity="1"></path>
            <path className="fill-(--firstWaveColor)"
