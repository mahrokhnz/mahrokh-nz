...
function Header() {
    return (
        <header
            className="relative flex justify-between before:absolute before:top-[15mm] before:left-[-23mm] before:text-[5mm] before:font-medium before:tracking-[2mm] before:text-(--whiteColor) before:content-['CV'] before:-rotate-90">
            ...
            <ul className="relative flex flex-col gap-[4mm] before:absolute before:top-[-12mm] before:left-[-2.3mm] before:z-[-1] before:h-[140%] before:w-[10mm] before:bg-(--darkColor) before:content-['']">
                ...
                <li className="flex gap-[12mm]">
                    ...
                    <a className={cls("text-[4.1mm]", "cursor-pointer font-semibold text-(--linkColor)")}
                       target='_blank' href="https://www.mahrokhnz.ir/">www.mahrokhnz.ir</a>
                </li>
                <li className="flex gap-[12mm]">
                    <FaLinkedin className="z-[1] text-[5mm] text-(--whiteColor)"/>
                    <a className={cls("text-[4.1mm]", "cursor-pointer font-semibold text-(--linkColor)")}
                       target='_blank' href="https://www.linkedin.com/in/mahrokh-nabizadeh-335326144/">Linkedin</a>
                </li>
                <li className="flex gap-[12mm]">
